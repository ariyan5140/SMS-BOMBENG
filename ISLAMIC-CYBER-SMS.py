...
\033[1;32m[-] AUTHOR    :\033[1;32m ISLAMIC CYBER
\033[1;32m[-] GITHUB    :\033[1;32m ISLAMIC CYBER
\033[1;32m[-] FACEBOOK  :\033[1;32m ISLAMIC CYBER
...
rp= 'ARIYAN'
x = 'HRIDOYE'
if 'ARIYAN'==user and 'HRIDOYE'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL JOIN MY FACEBOOK GROUP ")
	os.system('xdg-open https://www.facebook.com/profile.php?id=100091849444275')
else:
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH HRIDOYE ;) {w}<{r}/{w}>\n\n")
...
os.system("xdg-open https://facebook.com/groups/735209235013629/")
print (logo)
print(f"""\n{ran}\033[1;31m                                                               
\t\033[1;32m                 
\t\033[1;32m                
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥ISLAMIC CYBER🔥 "+w+tim)
